...
public class ChiTietSPService {
    ...
    public ChiTietSanPham update(String ma, ChiTietSPRequest request) {
        ...
        return optional.map(chiTietSanPham -> {
            chiTietSanPham.setSanPham(SanPham.builder().build());
            chiTietSanPham.setNhaSanXuat(NhaSanXuat.builder().id(request.getIdNSX()).build());
    ...
    public ChiTietSanPham add(ChiTietSPRequest request) {
